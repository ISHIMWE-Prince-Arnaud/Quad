  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      <div className="space-y-2">
        ...
        <div className="h-12 w-full rounded-2xl border border-border/40 bg-card px-4 flex items-center justify-between transition-colors">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          <SelectTrigger
            ...
            disabled={disabled}
            className={cn(
              "h-12 w-full rounded-2xl border border-border/40 bg-card px-4 text-sm font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary/40 transition-all",
