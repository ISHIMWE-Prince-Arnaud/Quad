            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{user.totalPosts || 0}</div>
                  <div className="text-sm text-gray-500">Posts</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{user.totalReactions || 0}</div>
                  <div className="text-sm text-gray-500">Reactions</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{userPosts.filter(p => p.isTopPost).length}</div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    {user.badges.map((badge) => (
                      <span
                        key={badge}
                        className="px-4 py-2 bg-gradient-to-r from-accent to-primary text-gray-900 rounded-full font-semibold text-sm shadow-md"
                      >
                        {badge}
                      </span>
                    ))}
