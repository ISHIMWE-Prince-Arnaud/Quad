...
export function OptimisticPostCard({ post }: { post: Post }) {
  ...
  return (
    <Card className="w-full bg-card border border-border/40 rounded-[2rem] overflow-hidden transition-all duration-300">
      ...
      <CardFooter className="px-6 py-4 flex items-center gap-2 border-t border-border/40 bg-muted/10">
        <div className="flex items-center gap-6 flex-1 text-muted-foreground">
