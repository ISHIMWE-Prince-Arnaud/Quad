      ...
      <div className="flex flex-col gap-1.5 w-full group">
        <div className="relative">
          <input
            type={type}
            className={cn(
              "flex h-11 w-full rounded-full border border-input bg-background/50 px-5 text-sm font-medium ring-offset-background transition-all placeholder:opacity-0 focus:placeholder:opacity-100 placeholder:text-muted-foreground/50 focus-visible:outline-none focus:border-primary disabled:cursor-not-allowed disabled:opacity-50",
